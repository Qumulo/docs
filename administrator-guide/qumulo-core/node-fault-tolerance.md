...
<ul>
  ...
  <li>There might be a compromise in usable capacity if your cluster is already is a heterogeneous cluster or if, after a node-add operation, it becomes a motley cluster and higher node fault tolerance becomes possible. In these scenarios, Qumulo Core maximizes usable capacity by default and offers the option to have a slighly lower increase capacity to increase the node fault tolerance level at the time of the node-add operation.</li>
</ul>
