...
1. To get more information about a specific Shift relationship, click **&vellip; > View Details**.
   ...
   {% include image.html alt="View Details Menu" file="/administrator-guide/qumulo-core/images/view-details-menu.png" %}
...
1. To stop a copy job for a specific relationship, click **&vellip; > Abort**.
   ...
   {% include image.html alt="Abort Menu" file="/administrator-guide/qumulo-core/images/abort-menu.png" %}
...
1. To stop a copy job for a specific relationship, click **&vellip; > Copy Again**.
   ...
   {% include image.html alt="Copy Again Menu" file="/administrator-guide/qumulo-core/images/copy-again-menu.png" %}
...
1. To stop a copy job for a specific relationship, click **&vellip; > Delete**.
   ...
   {% include image.html alt="Delete Menu" file="/administrator-guide/qumulo-core/images/delete-menu.png" %}
