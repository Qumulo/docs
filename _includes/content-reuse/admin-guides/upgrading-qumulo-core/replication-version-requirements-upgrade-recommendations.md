...
{% include tip.html content="From Qumulo Core 7.4.4 (and higher) we've added the &ldquo;Replication Compatibility&rdquo; section to the [release notes](https://nexus.qumulo.com/downloads/) of each release." %}
{% endif %}
