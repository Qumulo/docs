...
To view the exact permissions metadata for this file, run the {% include qq.html command="fs_file_get_attr" %}. For example:
...
To view the permissions configured in an ACL, run the {% include qq.html command="fs_get_acl" %}. For example:
