...
1. On the **LDAP Configuration** page, click **Edit** and then do the following:
   ...
   1. (Optional) For **Encrypt Connection**, click **Yes**.
      ...
      <ul>
        ...
        <li>To use encrypted connections, you must <a href="../authentication-qumulo-core/installing-signed-ssl-certificate.html">install a valid certificate for your LDAP server</a>.</li>
      </ul>
