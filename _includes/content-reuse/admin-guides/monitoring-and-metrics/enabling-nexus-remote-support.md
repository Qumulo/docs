...
{% else %}
{% include note.html content="Currently, Nexus Remote Support is best suited to on-premises and Cloud Native Qumulo (CNQ) clusters. We recommend [enabling VPN Remote Support](enabling-cloud-based-monitoring-vpn-remote-support.html) for on-premises clusters." %}
{% endif %}
