...
For all clusters created by using Qumulo Core 3.1.5 (and higher), [Qumulo Core enables at-rest encryption automatically](/administrator-guide/encryption-at-rest/managing-encryption-at-rest.html).
