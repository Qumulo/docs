...
echo "Building PDF-friendly HTML site for Qumulo-Certified Hardware Guide...";
bundle exec jekyll serve --detach --config _config.yml,pdfconfigs/config_hardware_guide_pdf.yml;
echo "done";
