...
usage: "qq create_object_backed_cluster [-h] --cluster-name CLUSTER_NAME --admin-password\
  \ ADMIN_PASSWORD --host-instance-id\n    HOST_INSTANCE_ID --object-storage-uris\
  \ OBJECT_STORAGE_URIS [OBJECT_STORAGE_URIS ...]\n    --usable-capacity-clamp USABLE_CAPACITY_CLAMP\
  \ --product-type PRODUCT_TYPE\n    [--node-ips-and-fault-domains NODE_IPS_AND_FAULT_DOMAINS\
  \ [NODE_IPS_AND_FAULT_DOMAINS ...]]\n    --accept-eula [--azure-key-vault-uri KEY_VAULT\
  \ | --key-vault KEY_VAULT]"
