...
usage: "qq set_monitoring_conf [-h] [--enabled | --disabled] [--vpn-enabled | --vpn-disabled]\n\
  ...
  \   [--mq-proxy-port MQ_PROXY_PORT] [--s3-proxy-host S3_PROXY_HOST]\n    [--s3-proxy-port\
  \ S3_PROXY_PORT] [--s3-proxy-disable-https]\n    [--all-proxy-host HOST] [--all-proxy-port\
  \ PORT] [--period PERIOD]\n    [--vpn-host VPN_HOST] [--nexus-enabled | --nexus-disabled]\n\
  \    [--nexus-host NEXUS_HOST] [--nexus-port NEXUS_PORT]\n    [--nexus-interval\
  \ NEXUS_INTERVAL]"
