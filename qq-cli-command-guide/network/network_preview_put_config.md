---
category: network
command: network_preview_put_config
optional_options:
- alternate: []
...
- alternate: []
  ...
  name: --templates
  required: false
permalink: /qq-cli-command-guide/network/network_preview_put_config.html
positional_options: []
sidebar: qq_cli_command_reference_sidebar
summary: This section explains how to use the <code>qq network_preview_put_config</code>
  command.
synopsis: Validate or overwrite the cluster-wide network configuration.
title: qq network_preview_put_config
usage: qq network_preview_put_config [-h] [--dry-run] (--file FILE | --modify | --templates)
