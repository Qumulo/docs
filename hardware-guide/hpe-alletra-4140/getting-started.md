...
{% include content-reuse/platform-agnostic-verify-node-preamble.md %}
   ...
   {% capture alt_tag %}Front Diagram of the {{site.all4140}} Node{% endcapture %}
   {% include image.html alt=alt_tag file="hpe-alletra-4140-front-panel-power.png" %}
