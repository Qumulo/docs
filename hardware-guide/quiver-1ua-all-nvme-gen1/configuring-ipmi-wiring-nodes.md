...
To configure the IPMI port, you must use the Server Management Interface. For more information, see [ASMB11-iKVM Server Management Board User Guide](/pdf/quiver-1ua-all-nvme-gen1-server-management-board-user-guide.pdf) in the ASUS documentation.
