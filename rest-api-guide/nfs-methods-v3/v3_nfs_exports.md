  ...
  get:
    ...
    response_body:
      schema: "{\n  \"description\": \"api_nfs_exports_v3\",\n  \"type\": \"object\"\
        ...
        \ mode hosts are required to authenticate with.:\\n * `AUTHENTICATION_MODE_KRB5`\
        ...
        \     \"enum\": [\n                    \"NFS_MAP_NONE\",\n               \
        \     \"NFS_MAP_ROOT\",\n                    \"NFS_MAP_ALL\"\n           \
        \       ],\n                  \"description\": \"NFS user mapping (squashing)\
...
redirect_from: /rest-api-guide/nfs-methods/v3_nfs_exports.html
deprecated: false
---
