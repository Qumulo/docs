---
category: /Network Configuration V2
methods:
  get:
    ...
    response_body:
      schema: "{\n  \"description\": \"api_interface_network_statuses\",\n  \"type\"\
        ...
        \        \"vpc_id\": {\n          \"description\": \"ID of the VPC for the\
        \ interface.\",\n          \"type\": \"string\"\n        },\n        \"security_groups\"\
        : {\n          \"type\": \"array\",\n          \"items\": {\n            \"\
        ...
        \  \"type\": \"string\"\n        },\n        \"ip_aliases\": {\n         \
        \ \"type\": \"array\",\n          \"items\": {\n            \"description\"\
        : \"List of IP aliases associated with this instance.\",\n            \"type\"\
        : \"string\"\n          }\n        },\n        \"network\": {\n          \"\
...
api_version: v2
permalink: /rest-api-guide/network-configuration-v2/v2_network_interfaces_interface_id_status_node_id.html
sidebar: rest_api_guide_sidebar
redirect_from: /rest-api-guide/network-configuration/v2_network_interfaces_interface_id_status_node_id.html
---
