---
category: /Cluster Slots V1
methods:
  get:
    summary: Retrieve info about the node's disk slots
    parameters:
    - name: node_id
    ...
    response_body:
      schema: "{\n  \"type\": \"array\",\n  \"items\": {\n    \"description\": \"\
        ...
        \ API_DEVICE_MEDIA_TYPE_UNKNOWN,\\n * `Ephemeral SSD` - The device type of\
        \ a disk used for the read cache on object-backed clusters,\\n * `HDD` - API_DEVICE_MEDIA_TYPE_SPINNING_DISK,\\\
        ...
        n * `Write Tier SSD` - The device type of a disk used for the write cache\
        \ on object-backed clusters\"\n      },\n      \"disk_model\": {\n       \
        \ \"description\": \"Disk model (empty if no disk)\",\n        \"type\": \"\
        string\"\n      },\n      \"disk_serial_number\": {\n        \"description\"\
        : \"Serial number of this disk (empty if no disk)\",\n        \"type\": \"\
        string\"\n      },\n      \"capacity\": {\n        \"description\": \"Capacity\
        \ in bytes (0 if slot is empty)\",\n        \"type\": \"string\"\n      },\n\
        \      \"raw_capacity\": {\n        \"description\": \"Raw capacity in bytes\
        \ (0 if slot is empty)\",\n        \"type\": \"string\"\n      },\n      \"\
        ...
        \ capacity in bytes for slot\",\n        \"type\": \"string\"\n      },\n\
        \      \"high_endurance\": {\n        \"description\": \"Is this device a\
        \ high endurance model\",\n        \"type\": \"boolean\"\n      },\n     \
    ...
    preview: false
rest_endpoint: /v1/cluster/slots/node/{node_id}
api_version: v1
permalink: /rest-api-guide/cluster-slots-v1/cluster_slots_node_node_id.html
sidebar: rest_api_guide_sidebar
redirect_from: /rest-api-guide/cluster-slots/cluster_slots_node_node_id.html
deprecated: false
---
